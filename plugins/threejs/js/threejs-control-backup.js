...
var scene3d = document.getElementById("product3D");
...
var initRender = function(width, height) {
    ...
    mtlLoader.setTexturePath('plugins/threejs/js/3dcake/');
    mtlLoader.setPath('plugins/threejs/js/3dcake/');
    mtlLoader.load('mesh.mtl', function(materials) {
        ...
        objLoader.setPath('plugins/threejs/js/3dcake/');
